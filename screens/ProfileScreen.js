    ...
    <ScrollView style={styles.container}>
      <View style={{ marginBottom: 30 }}>
        ...
        >
          ...
          >
            <AntDesign name="home" size={18} color="#ff1654" />
            {"  " + homename}
          </Text>
        </View>
        <TouchableOpacity onPress={() => navigation.navigate("SetProfile")}>
          <View style={[styles.homes]}>
            <Text style={styles.homeText}>Profil Ayarları</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate("SetHomeScreen")}>
          <View style={[styles.homes]}>
            <Text style={styles.homeText}>Ev Ayarları</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={[styles.homes]}>
        ...
        <TouchableOpacity>
          <View style={[styles.homes]}>
            <Text style={styles.homeText}>Çıkış</Text>
          </View>
        </TouchableOpacity>
      </View>
    </ScrollView>
