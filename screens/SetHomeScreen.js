...
const SetHomeScreen = ({ navigation, route }) => {
      ...
      <View style={{ marginBottom: 30 }}>
        ...
        <TouchableOpacity>
          <View style={styles.borcDurumu}>
            <Text style={styles.borcText}>Evin İsmini Değiştir</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={styles.borcDurumu}>
            <Text style={styles.borcText}>Evin Şifresini Değiştir</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={styles.borcDurumu}>
            <Text style={styles.borcText}>Ev Kodunu Kopyala</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={styles.borcDurumu}>
            <Text style={styles.borcText}>Evi Sil</Text>
          </View>
        </TouchableOpacity>
      </View>
    </ScrollView>
